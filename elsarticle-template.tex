...
\caption{Flowchart associated with data preparation for the study of Gahagan bifaces. The pseudolandmarks generated by the \textit{auto3dgm} algorithm were employed as an exploratory tool, and were not used in the final analysis.}
\label{fig:figflow}
\end{figure}
...
\caption{Landmark and semilandmark placement.}
\label{fig:fig5}
\end{figure}
...
\caption{Degree between vectors placed at those cross-sections nearest the base and tip of the biface as a potential measure of beveling.}
\label{fig:beveling}
\end{figure}
